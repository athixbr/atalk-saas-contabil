...
export default function Options(props) {
  ...
  useEffect(() => {
    for (const [key, value] of Object.entries(settings)) {
      ...
      if (key === "sendMessageOutExpedientTicketOpen") setSendMessageOutExpedientTicketOpen(value)
  ...
  async function handleSendMessageOutExpedientTicketOpen(value) {
    ...
    await update({
      column:"sendMessageOutExpedientTicketOpen",
      data:value
    });
    setLoadingSendMessageOutExpedientTicketOpen(false);
  }
